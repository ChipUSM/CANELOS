...
<div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-start; gap: 40px; width: 100%;">
    ...
    <div style="flex: 1; min-width: 320px;">
        ...
        <iframe src="https://maps.google.com/maps?q=Universidad%20T%C3%A9cnica%20Federico%20Santa%20Mar%C3%ADa%2C%20Valpara%C3%ADso&t=&z=16&ie=UTF8&iwloc=&output=embed" width="100%" height="350" style="border:0; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
