...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 30px;">
    ...
    <a href="{{ "/programa/#workshop" | relative_url }}" style="text-decoration: none; color: inherit;">
        <div style="background-color: #f7f9fc; border-left: 5px solid #003002; padding: 25px; border-radius: 8px; width: 350px; box-shadow: 0 3px 8px rgba(0,0,0,0.05); cursor: pointer;">
